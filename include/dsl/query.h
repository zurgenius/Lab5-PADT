...
class JoinPipe {
  public:
    JoinPipe(ExprPtr right, const std::string &left_column, const std::string &right_column);
...
ExprPtr Table(const std::string &name, std::initializer_list<std::string> schema);
...
JoinPipe Join(ExprPtr right, const std::string &left_column, const std::string &right_column);
